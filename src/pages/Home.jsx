    ...
    <>
      <section className="hero">
        <div className="heroContent">
          ...
          <p className="heroText">
            ...
            service-based brands with custom renovations, websites, automation
            tools, and cloud-backed systems.
          </p>
          ...
          <div className="heroActions">
            ...
            <Link className="secondaryButton" to="/past-work">
              View Work
            </Link>
          </div>
        </div>
        ...
        <div className="grid three">
          <div className="serviceCard">
            ...
            <p>
              ...
              around cleaner design, stronger function, and better everyday use.
            </p>
          </div>
      ...
      <section id="cloud-demo" className="section cloudSection">
        <div className="sectionHeader centered">
          ...
          <p>
            A practical automation system that helps businesses collect customer
            requests, organize leads, send notifications, and make follow-up
            easier.
          </p>
        </div>
        ...
        <div className="cloudDemoGrid">
          <div className="cloudDemoContent">
            ...
            <p>
              This demo shows how a small business can replace scattered texts,
              emails, phone notes, and manual spreadsheets with one simple quote
              request workflow.
            </p>
            <p>
            ...
            <div style={{ marginTop: "28px" }}>
              <Link className="primaryButton" to="/contractor-demo">
                View Live Contractor Demo
              </Link>
            </div>
          </div>
          ...
          <div className="cloudWorkflowCard">
            ...
            <div className="cloudTechStack">
              ...
              <strong>
                API Gateway • Lambda • DynamoDB • SES • CloudWatch • React
              </strong>
            </div>
          </div>
        </div>
      ...
      <section className="section starterSection">
        <div className="starterBox">
          ...
          <div>
            <p>
              Karven Systems is currently taking on a few small starter projects
              with no upfront service fee. If the finished work is helpful and
              you are satisfied with it, you can pay whatever you think is fair.
            </p>
            <p>
              This is a simple way to test a website, quote form, intake
              workflow, automation, or small digital system before committing to
              a larger project.
            </p>
            <a className="primaryButton" href="#contact">
      ...
      <section className="section processSection">
        ...
        <div className="processGrid">
          <div className="processStep">
            ...
            <p>
              We look at the current process, what is taking too much time, and
              where a website, automation, renovation, or custom tool could
              help.
            </p>
          </div>
        ...
        <div className="about">
          ...
          <div>
            <p>
              ...
              professional with hands-on experience building and renovating real
              spaces.
            </p>
            <p>
            ...
            <p>
              The focus is not overcomplicated software or overbuilt spaces. It
              is practical work that helps small businesses save time, stay
      ...
      <section id="contact" className="section contactSection">
        <div className="contactBox">
          ...
          <h2>
            Have a space, website, workflow, or business system you want built?
          </h2>
          <p>
            Send a message with what you currently do manually, what type of
            customers you serve, and what you would like to make easier. Karven
            Systems will help map out the simplest solution.
          </p>
          ...
          <div className="contactLinks">
            <a href="mailto:karvensystems@gmail.com">
              karvensystems@gmail.com
            </a>
            <a
